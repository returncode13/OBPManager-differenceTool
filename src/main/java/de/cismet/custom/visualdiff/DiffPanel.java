...
public class DiffPanel extends javax.swing.JPanel {
    ...
    public void update() {
        ...
        try {
            ...
            DiffView diffv=Diff.getDefault().createDiff(sourceLeft, sourceRight);
            view = diffv;
                        pnlDiff.removeAll();
    ...
    private void initComponents() {
        ...
        txtFilesMissing.setText(org.openide.util.NbBundle.getMessage(DiffPanel.class, "DiffPanel.txtFilesMissing.text")); // NOI18N
        ...
        lblWaitingImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/custom/visualdiff/load.png"))); // NOI18N
